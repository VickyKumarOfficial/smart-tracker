...
const recentTransactions = [
  { date: 'Oct 24, 2023', time: '14:30 PM', project: 'Custom Oak Table', amount: '$1,200.00', status: 'PAID' },
  { date: 'Oct 22, 2023', time: '09:15 AM', project: 'Ceramic Vase Set', amount: '$350.00', status: 'PAID' },
  { date: 'Oct 15, 2023', time: '16:45 PM', project: 'Leather Briefcase', amount: '$850.00', status: 'OVERDUE' },
  { date: 'Oct 10, 2023', time: '11:00 AM', project: 'Silver Pendant', amount: '$220.00', status: 'PENDING' },
];

export function Dashboard() {
  return (
    <div className="max-w-6xl mx-auto py-8">
      <h1 className="text-3xl font-medium text-[#8B3A1C] mb-8">Overview</h1>
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-stone-500">Recent transactions across all projects.</p>
          </div>
              ...
              {recentTransactions.map((tx, i) => (
                <tr key={i} className="text-sm text-stone-900 hover:bg-stone-50/50 transition-colors">
                  <td className="px-6 py-5">
                    <div>{tx.date}</div>
                    <div className="text-stone-500 text-xs mt-0.5">{tx.time}</div>
                  </td>
                  <td className="px-6 py-5 font-medium">{tx.project}</td>
                  ...
                  <td className="px-6 py-5 text-right">
                    <button className="text-xs font-semibold tracking-wider text-stone-500 border border-stone-200 rounded px-3 py-1.5 hover:bg-stone-50 hover:text-stone-900 transition-colors">Show History</button>
                  </td>
                </tr>
              ))}
            </tbody>
